...
LIBS=$(NAIAD_LIBS)
APPNAME=bin/geo2emp
SOURCES=thirdparty/anyoption/anyoption.C thirdparty/pystring/pystring.C src/cli_geo2emp.C src/empload.C src/empsave.C src/geo2emp.C src/geo2emp_utils.C
